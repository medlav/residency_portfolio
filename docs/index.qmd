...
::: {.hero-section}
![](../assets/icon/foreground-icon.png){width="160px"}
...
[View API Docs](./api/index.html) | [GitHub Repository](https://github.com/medlav/residency_portfolio)
:::

::: {.marquee-container}
::: {.marquee-content}
![](screenshots/intro_screen.png){.app-shot}
![](screenshots/homepage_empty.png){.app-shot}
![](screenshots/homepage_filled.png){.app-shot}
![](screenshots/homepage_it_dark.png){.app-shot}
![](screenshots/drawer_empty.png){.app-shot}
![](screenshots/profile_empty.png){.app-shot}
![](screenshots/profile_filled.png){.app-shot}
![](screenshots/profile_filled_it.png){.app-shot}
![](screenshots/activities_empty.png){.app-shot}
![](screenshots/activities_filled_1.png){.app-shot}
![](screenshots/activities_filled_2.png){.app-shot}
![](screenshots/activities_it_dark.png){.app-shot}
![](screenshots/activity_form_filled.png){.app-shot}
![](screenshots/activity_form_it_dark.png){.app-shot}
![](screenshots/activity_form_save_confirm.png){.app-shot}
![](screenshots/ongoing_filled_it_dark.png){.app-shot}
![](screenshots/categories_it_dark.png){.app-shot}
![](screenshots/category_form_it_dark.png){.app-shot}
![](screenshots/specialties_it_dark.png){.app-shot}
![](screenshots/portfolio_empty.png){.app-shot}
![](screenshots/portfolio_filled_it_dark.png){.app-shot}
![](screenshots/portfolio_table.png){.app-shot}
![](screenshots/current_curriculum.png){.app-shot}
![](screenshots/curriculum_print.png){.app-shot}
![](screenshots/settings_light.png){.app-shot}
![](screenshots/settings_dark.png){.app-shot}
![](screenshots/language_confirm.png){.app-shot}
![](screenshots/backup_dark.png){.app-shot}
![](screenshots/export_filepicker.png){.app-shot}
![](screenshots/import_db_confirm.png){.app-shot}
![](screenshots/info_dark.png){.app-shot}
:::
